...
namespace MasteryMarks
{
    public class TankMasteryMarks
    {
        ...
        public double MarksGettingsProbability => Math.Round((NumberOfMasteryMarks + NumberOfMastery1Marks + NumberOfMastery2Marks + NumberOfMastery3Marks) / (double)NumberOfBattles, 2);
    }
}